...
<footer class="bg_dark footer_dark">
    <p style="position:absolute; left: 0; right: 0; bottom:408px; text-align: center;" class="footlogo"><img src="{{ env('MAIN_URL') }}public/assets/images/loading_logo.png" style=" margin:0 auto; text-align: center; width:20%;"></p>
