...
<footer class="bg_dark footer_dark">
    ...
    <p style="position:absolute; left: 0; right: 0; bottom:408px; text-align: center;" class="footlogo"><img
    ...
    <a href="mailto:lakshmikalyanam@kinchit.org" contenteditable="false" style="cursor: pointer;">lakshmikalyanam@kinchit.org</a>
                ...
                <div class="col-lg-4 col-md-5">
                    ...
                    <!-- <h5 class="widget_title"
                        style="font-size: 30px; margin-top:20px !important; margin-bottom:5px !important;">Stay
                        Connected</h5>
