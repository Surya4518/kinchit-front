...
<footer class="bg_dark footer_dark">
    <p style="position:absolute; left: 0; right: 0; bottom:537px; text-align: center;" class="footlogo"><img src="{{ env('MAIN_URL') }}public/assets/images/loading_logo.png" style=" margin:0 auto; text-align: center; width:20%;"></p>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-5 mb-4 mb-lg-0">
                    ...
                    <ul class="list_none widget_links links_style2" style="list-style: none !important;">
                        ...
                        <li><a href="https://senthil.in.net/kinchit/"><i class="fa fa-angle-right" style="padding-right:10px;"></i>Home</a></li>
                           <li><a href="become-a-member.php"><i class="fa fa-angle-right" style="padding-right:10px;"></i>Become a Member</a></li>

                                  <li><a href="become-a-volunteer.php"><i class="fa fa-angle-right" style="padding-right:10px;"></i>Apply to be a Volunteer</a></li>
                                          <li><a href="audio.php"><i class="fa fa-angle-right" style="padding-right:10px;"></i>Audio</a></li>

        <li><a href="vedio.php"><i class="fa fa-angle-right" style="padding-right:10px;"></i>Video</a></li>

           <li><a href="en-pani.php"><i class="fa fa-angle-right" style="padding-right:10px;"></i>Kinchit En PaNi - App Satsang</a></li>


                                       <li><a href="https://senthil.in.net/lakshmi_kalyanam/index.php"><i class="fa fa-angle-right" style="padding-right:10px;"></i>Lakshmi Kalyanam</a></li>

                                       <li><a href="dharmasandheha.php"><i class="fa fa-angle-right" style="padding-right:10px;"></i>Dharma Sandeha</a></li>

                                       <li><a href="contact.php"><i class="fa fa-angle-right" style="padding-right:10px;"></i>Contact</a></li>
...
Chennai – 600 004. Tamilnadu, India.
                        ...
                        <li>
                          ...
                          <p style="font-size:16px;">  kinchitkaram@yahoo.co.in</p>
                        </li>
                    </ul>

                      <h5 class="widget_title" style="font-size: 30px; margin-top:20px !important; margin-bottom:5px !important;">Stay Connected</h5>
            <ul class="list_none social_icons text-left social_white  mt-2 mt-md-0">
                     <li><a href="https://www.facebook.com/Kinchitkaram/" target="_blank"><i class="ion-social-facebook"></i></a></li>
                        ...
                        <li><a href="https://www.instagram.com/velukkudi/" target="_blank"><i class="ion-social-instagram-outline"></i></a></li></ul>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center">
            <div class="col-12">
                <div class="bottom_footer border_top_transparent">
                    <div class="row">
                        <div class="col-md-12">
                            <p class="copyright m-md-0 text-center text-md-center">Copyrights © 2023 - Kinchitkaram Trust. All Rights Reserved.
   ...
   <a href="donation.php" class="Instagram"><i class="fa fa-money" aria-hidden="true"></i>Online Donation </a>
 <a href="https://www.facebook.com/466957886688797?ref=embed_page" class="Facebook"><i class="fab fa-facebook-f"> </i> Facebook </a>
