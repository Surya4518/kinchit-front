...
<header class="header_wrap dark_skin main_menu_uppercase main_menu_weight_600 menu_style1">
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "{{ env('API_URL') }}user-login-update",
      ...
      CURLOPT_POSTFIELDS =>'{
        "token" : "qtFrWBY6E6ABZjuE6xYjpVVtRn00PYiI7gjCaPOl6EF8J3lzro"
    }',
    ...
    $json = json_decode($response, true);
     if($json['status'] == 200) {
         setcookie('marital_acc', $json['marital_acc'], time() + (86400 * 30), "/"); // 86400 = 1 day, '/' means the cookie is available in the entire domain
         setcookie('token', $json['user_token'], time() + (86400 * 30), "/");
         setcookie('typeofuser', $json['user_type'], time() + (86400 * 30), "/");
     }
    }
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 col-lg-4 mobileicons text-center">
                    ...
                    @if ($token != null)
                    @if ($typeofuser != null)
                    <span style="background-color:#ff2a00; padding:10px 5.5px; color:#fff;border-radius:10px;font-size: 15px;"><a href="{{ env('MAIN_URL') }}my-profile"
                            style="color:#fff;"><i class="fa fa-user" style="padding-right:10px; color:#fff;"></i>My
                            Profile</a></span>
                            
                             <span style="background-color:#ff2a00; padding:10px 5.5px; color:#fff;margin: 0 0px -1px 9px; border-radius:10px;font-size: 15px;"><a href="javascript:Logout();"
                            style="color:#fff;"> <i class="fa fa-lock"
                                style="padding-right:10px; color:#fff;"></i>Logout</a></span>
                                
                                  <span  class="dont" style="background-color:#ff2a00; padding:10px 5.5px; color:#fff;margin: 0 0px -1px 9px; border-radius:10px;font-size: 15px;"><a href="{{ env('MAIN_URL') }}donation"
                            style="color:#fff;"> <i class="fa fa-money"
                                style="padding-right:8px; color:#fff;"></i>Online Donation</a></span>
                    @else
                    <span style="background-color:#ff2a00; padding:10px 5.5px; color:#fff;border-radius:10px;font-size: 15px;"><a href="{{ env('MAIN_URL') }}user-register"
                            style="color:#fff;"><i class="fa fa-user"
                                style="padding-right:10px; color:#fff;"></i>Register</a></span>
                            
                            <span style="background-color:#ff2a00; padding:10px 5.5px; color:#fff;margin: 0 0px -1px 9px; border-radius:10px;font-size: 15px;"><a href="{{ env('MAIN_URL') }}user-login"
                            style="color:#fff;"> <i class="fa fa-lock"
                                style="padding-right:10px; color:#fff;"></i>Login</a></span>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu" style="width:300px;">
                            <ul>
                                <li><a class="dropdown-item nav-link nav_item" href="{{ env('MAIN_URL') }}become-member"><i
