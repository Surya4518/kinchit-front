                ...
                <div class="row gutter-y-50">
                    ...
                    <div class="col-xl-12 col-md-12">
                        <div class="about-one__content">
                            ...
                            <h2 class="d-shead mb-4">This website is strictly for matrimonial purpose only and not a dating website and should not be used for posting obscene material.</h2>
                                <!-- /.about-one__text-box__image -->
                                <p class="dis-para"><a href="#" class="def-anc">Lakshmi Kalyanam </a>does not guarantee the accuracy, completeness, or usefulness of any information on the service and neither adopts nor endorses it.
                                <a href="#" class="def-anc">Lakshmi Kalyanam </a> is in no way responsible for the accuracy or reliability of any opinion, advice, profile listing, contact mail, or statement made.
         under no circumstances will <a href="#" class="def-anc">Lakshmi Kalyanam </a> be responsible for any loss or damage resulting from anyone's reliance on information or other content posted on <a href="#" class="def-anc">Lakshmi Kalyanam </a> service, or transmitted to <a href="#" class="def-anc">Lakshmi Kalyanam </a> members.
          It is the responsibility of the visitors to perform appropriate enquiries and validate the content to own satisfaction.</p>
