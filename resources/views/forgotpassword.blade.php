...
<body>
    ...
    <section class="login-frm mb-5">
        <div class="container">
            <div class="row justify-content-center">
                <!-- <p><strong>Note: </strong>USE YOUR 10-DIGIT REGISTERED MOBILE NUMBER AS USERNAME & PASSWORD
                    TO LOG IN</p> -->
                <div class="col-md-8">
                    ...
                    <div class="card card-outline-secondary">
                        <div class="card-header">
                            <h3 class="mb-0 fm-head">Forgot Password</h3>
                        ...
                        <div class="card-body fm-body">
                            <form method="post" enctype="multipart/form-data" id="login_form">
                                ...
                                <input class="form-control" id="device_id" value="1" name="device_id" type="hidden">
                                    <label for="username" class="fm-name">Registered Email</label>
                                    <input class="form-control" id="email" name="email" type="text">
                                    <p class="validate_errors" id="email_error"
                                        style="color: #f90404;font-size: 13px;font-family: 'circular';"></p>
                                </div>
                                <!-- <div class="form-group">
                                    <label class="fm-name">Password</label>
                            ...
                            <!-- <div class="form-check small">
                                <a href="forgot-password">
                                    <h3 class="mb-0 fm-head1">Forgot Password?</h3>
                                </a>

                            </div> -->
                            <div class="text-center my-3">
                                <button class="sum" type="button user-login"
                                    onclick="ForgotPassword()">Forgot Password</button>
                            </div>
                            <!-- <div class="col-md-12 text-center">
                                <label class="Forgot-text text-white">Not Registered yet? </label> <a href=""
                                    class="Forgot-text pl-1 " contenteditable="false"
                                    style="cursor: pointer;text-decoration: underline;">Register Now</a>
                            </div> -->
                        </div><!--/card-block-->
                    </div><!-- /form card login -->
                </div>
    ...
    <script>
        ...
        function ForgotPassword() {
            ...
            $.ajax({
                type: 'post',
                url: "{{ env('API_URL') }}forget-password",
                data: formdata,
                processData: false,
                contentType: false,
