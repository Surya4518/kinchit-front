            ...
            <div class="row mb-4">
                <div class="col-md-12 mx-auto">
                    <div class="media-controls ">
                        <h5><i class="fa fa-music text-danger" aria-hidden="true"></i><span id="show_audio_title"></span>
                        </h5>
                        ...
                        <div class="media-progress">
                            <div class="progress-time">
                                ...
                                <div class="volume-control">
                                    ...
                                    <input type="range" min="0" max="1" step="0.01" value="1" id="volumeSlider" oninput="updateVolume()">
                                </div>
                            </div>
                        </div>
 ...
 <div class="playlist-ctn"></div>
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    <h2 class="py-1 text-white text-center">${response.data[i].parent_title}</h2>`;
                        ...
                        var numPerPage = 15; // Adjust this number according to your preference
                        var $divs = $(".audios-list-show > .col-md-12 > .categories > .audios");
                        console.log($divs)
        ...
        function showPage(page) {
            ...
            var $divs = $(".audios-list-show > .col-md-12 > .categories > .audios");
            $divs.hide().slice(startIndex, endIndex + 15).show();
        }
