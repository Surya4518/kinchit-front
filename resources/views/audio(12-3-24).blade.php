            ...
            <div class="col-12   my-5 mt-0 p-3">
                <div class="audio-list">
                    ...
                    <div class="row justify-content-evenly audios-list-show">
                        ...
                        <div class="col-md-5 ">
                            <div class="categories audi-sec" id="categories2">
                                <h5 class="py-1 text-white">002-Sheshatvam</h5>
                                <div class="audios" id="audios1">
                                    <!-- <div class="name1">name1</div> -->
                                    <button onclick="playAudio(2,1)"> <i class="fa fa-music text-dark"
                                            aria-hidden="true"></i> 01 Theemai
                                        Neekki Nanmai Alikkum Thudhigal</button>
                                    <input type="hidden" name="audio1" id="audio1"
                                        value="https://ia802900.us.archive.org/16/items/mythium/AC_TSOWAfucked_up.mp3">
                                </div>
                                <div class="audios" id="audios2">
                                    <!-- <div class="name2">name2</div> -->
                                    <button onclick="playAudio(2,2)"> <i class="fa fa-music text-dark"
                                            aria-hidden="true"></i> 01 Theemai
                                        Neekki Nanmai Alikkum Thudhigal</button>
                                    <input type="hidden" name="audio2" id="audio2"
                                        value="https://archive.org/download/mythium/BS_ATKM.mp3">
                                </div>
                            </div>
                        </div>
                    </div>
