...
<body>
  ...
  <section class="bred-crum" style="background-image:url({{env('MAIN_URL')}}public/assets/images/breadcrum/header.jpg);">
    <div class="container">
      <h2 class="page-title">Send Messages</h2>
  ...
  <section class=" about-one--home section-space1">
    ...
    <div class="container">
      <div class="row gutter-y-50 justify-content-center mb-5">
        <p class="text-center mb-4">Listed Below are <strong>Sent</strong> messages.</p>
...
<div class="col-4" style="align-self: center;">
  ...
  <script>
    ...
    $.ajax({
        type: 'post',
        url: "{{ env('API_URL') }}get-send-inbox",
        data: formdata,
        processData: false,
        contentType: false,
        success: function(response) {
            if (response.status == 200) {
                ...
                messageData.forEach(function(message) {
                    ...
                    <div class="card-client1 mb-3">
                        <div class="row">
                            <div class="col-4">
                                <h2 class="mymatc-id"><a href="#" class="def-anc">${ToID}</a></h2>
                            </div>
                            <div class="col-4" style="align-self: center;">
                                <a href="#" class="horo-a" contenteditable="false" style="cursor: pointer;" data-toggle="modal" data-target="#exampleModal1" onclick="ReceivedInbox('${ToID}'); return false;"><i class="fa fa-user"></i> View Message</a>
                            </div>
                            <div class="col-4" style="align-self: center;">
    ...
    $(document).ready(function() {
      $('.horo-a').click(function(event) {
        ...
        console.log('Clicked');
        var fromID = $(this).data('toid');
        console.log('To ID:', ToID);
        ReceivedMessages(ToID);
    ...
    function ReceivedInbox(toid) {
      ...
      $.ajax({
        type: 'post',
        url: "{{ env('API_URL') }}inbox-messages",
        data: formdata,
        processData: false,
        contentType: false,
        success: function(response) {
