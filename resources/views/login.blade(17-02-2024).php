...
<body>
    ...
    <section class="bred-crum" style="background-image:url(assets/images/breadcrum/header.jpg);">
        <div class="container">
                        ...
                        <div class="card-body fm-body">
                            <form method="post" enctype="multipart/form-data" id="login_form">
                                <div class="form-group">
                                    <label for="username" class="fm-name">Username Email or Mobile Number </label>
                            ...
                            <div class="text-center my-3">
                                <button class="btn btn-success btn-lg  fm-btn" type="button user-login"
                                    onclick="LoginTheUser()">Login</button>
                            </div>
